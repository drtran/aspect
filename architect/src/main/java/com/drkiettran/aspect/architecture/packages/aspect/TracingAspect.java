...
public class TracingAspect extends CallTracker {
	...
	@Around("com.drkiettran.aspect.architecture.packages.SystemArchitecture.Repository() || com.drkiettran.aspect.architecture.packages.SystemArchitecture.Service()")
