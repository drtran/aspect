...
public class TracingAspect extends CallTracker {
	...
	@Around("com.drkiettran.aspect.architecture.annotations.SystemArchitecture.Repository() || com.drkiettran.aspect.architecture.annotations.SystemArchitecture.Service()")
